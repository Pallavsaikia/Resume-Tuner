...
class ExtractResumeFieldToolSchema(BaseModel):
    ...
    latest_designation: str = Field(..., description="Latest Designation at the top of the resume")
    phone_no: str = Field(..., description="Phone Number at the top of resume")
    location: str = Field(..., description="Location at the top of the resume")
